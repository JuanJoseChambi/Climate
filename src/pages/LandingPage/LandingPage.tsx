  ...
  return (
    <>
      <header className="flex flex-col h-screen w-screen justify-start items-center ">
        ...
        <section className="area flex flex-row justify-between py-10 sm:py-16 flex-wrap">

          <article className="w-[560px] flex-grow">
            <h1 className="text-6xl font-black" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
